...
class cct_payment extends ctl_payment {
    ...
    function getcard(&$allApp){
        $allApp[] = array(
            'pay_id' => '99',
            'pay_name' => 'LatiPay',
            'pay_ident' => 'pay_latipay',
            'version' => '1.0',
            'pay_intro' => 'LatiPay',
            'pay_contents' => 'LatiPay',
            'pay_down_url' => 'http://sds.ecos.shopex.cn/payments/apps/pay_latipay.tar',
            'pay_type' => 'common',
            'pay_logo' => 'http://sds.ecos.shopex.cn/payments/logos/pay_latipay.gif',
            'sort' => '10',
            'hidden' => false,
            'status' => true,
            'set' => true,
