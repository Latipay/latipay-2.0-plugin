...
class pay_latipaymoneymore extends paymentPlugin
{
    ...
    var $charset = 'utf-8';
    var $submitUrl = 'https://merchant.latipay.net/api/show.action';
    ...
    function toSubmit($payment)
    {
        ...
        $params = array(
            ...
            'callback_url' => $this->serverCallbackUrl,
            //'backPage_url' => '',
            'merchant_reference' => $payment["M_OrderId"] . '_' . uniqid(),
            'ip' => remote_addr(),
    ...
    function callback($in, &$paymentId, &$money, &$message, &$tradeno)
    {
        ...
        if (!$tradeno) $tradeno = $MyPaymentId;
