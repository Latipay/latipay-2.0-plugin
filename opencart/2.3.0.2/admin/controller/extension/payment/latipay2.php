...
class ControllerExtensionPaymentLatipay2 extends Controller {
	...
	public function index() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('extension/payment/latipay2', 'token=' . $this->session->data['token'], true)
		);

		$data['action'] = $this->url->link('extension/payment/latipay2', 'token=' . $this->session->data['token'], true);
